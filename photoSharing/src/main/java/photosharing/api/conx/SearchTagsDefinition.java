...
/**
 * The class calls the API for searching tags in the Files Service 
 * <a href="http://ibm.co/1JubBe2">Files Feed APIs</a>
 * 
...
public class SearchTagsDefinition implements APIDefinition {
	...
	private String getApiUrl(String query){
		...
		String apiUrl = "https://" + server + "/files/oauth/api/tags/feed?format=json&scope=document&pageSize=16&filter=" + query;
		return apiUrl;
	}
